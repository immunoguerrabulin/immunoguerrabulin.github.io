---
layout: post
title: "No Prisoner Be: Joyce DiDonato and Time for Three"
description: "Concert Review of Joyce DiDonato and Time for Three on Feb. 10 at the Chicago Symphony Center."
tags: [music]
categories: [music]
---
...
{% include video.liquid path="assets/img/blog/no-prisoner-be-joyce-didonato-and-time-for-three/time_for_three_wedding_proposal.mp4" class="img-fluid rounded z-depth-1 mx-auto d-block" width="720" controls=true caption="Time for Three at the meet and greet playing music for a marriage proposal." %}
...
<div class="row">
  <div class="col-md-6">
    {% include figure.liquid path="assets/img/blog/no-prisoner-be-joyce-didonato-and-time-for-three/no-prisoner-be-joyce-didonato-and-time-for-three.jpg" class="img-fluid rounded z-depth-1 mx-auto d-block" max-width="520px" alt="Joyce DiDonato and Time for Three performance" caption="Joyce DiDonato, Time for Three, and Kevin Puts." zoomable=true %}
  </div>
  <div class="col-md-6">
    {% include figure.liquid path="assets/img/blog/no-prisoner-be-joyce-didonato-and-time-for-three/joyce-jose.jpg" class="img-fluid rounded z-depth-1 mx-auto d-block" max-width="520px" alt="Jose with Joyce DiDonato" caption="Post-concert photo with Joyce DiDonato." zoomable=true %}
  </div>
</div>
